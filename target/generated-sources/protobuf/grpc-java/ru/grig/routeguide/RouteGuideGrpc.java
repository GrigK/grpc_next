...
public final class RouteGuideGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ru.grig.routeguide.Point,
      ru.grig.routeguide.Feature> getGetFeatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeature",
      requestType = ru.grig.routeguide.Point.class,
      responseType = ru.grig.routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.grig.routeguide.Point,
      ru.grig.routeguide.Feature> getGetFeatureMethod() {
    io.grpc.MethodDescriptor<ru.grig.routeguide.Point, ru.grig.routeguide.Feature> getGetFeatureMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getGetFeatureMethod = RouteGuideGrpc.getGetFeatureMethod) == null) {
          RouteGuideGrpc.getGetFeatureMethod = getGetFeatureMethod = 
              io.grpc.MethodDescriptor.<ru.grig.routeguide.Point, ru.grig.routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "routeguide.RouteGuide", "GetFeature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ru.grig.routeguide.Rectangle,
      ru.grig.routeguide.Feature> getListFeaturesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListFeatures",
      requestType = ru.grig.routeguide.Rectangle.class,
      responseType = ru.grig.routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<ru.grig.routeguide.Rectangle,
      ru.grig.routeguide.Feature> getListFeaturesMethod() {
    io.grpc.MethodDescriptor<ru.grig.routeguide.Rectangle, ru.grig.routeguide.Feature> getListFeaturesMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getListFeaturesMethod = RouteGuideGrpc.getListFeaturesMethod) == null) {
          RouteGuideGrpc.getListFeaturesMethod = getListFeaturesMethod = 
              io.grpc.MethodDescriptor.<ru.grig.routeguide.Rectangle, ru.grig.routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "routeguide.RouteGuide", "ListFeatures"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.Rectangle.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ru.grig.routeguide.Point,
      ru.grig.routeguide.RouteSummary> getRecordRouteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
      requestType = ru.grig.routeguide.Point.class,
      responseType = ru.grig.routeguide.RouteSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<ru.grig.routeguide.Point,
      ru.grig.routeguide.RouteSummary> getRecordRouteMethod() {
    io.grpc.MethodDescriptor<ru.grig.routeguide.Point, ru.grig.routeguide.RouteSummary> getRecordRouteMethod;
    if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
          RouteGuideGrpc.getRecordRouteMethod = getRecordRouteMethod = 
              io.grpc.MethodDescriptor.<ru.grig.routeguide.Point, ru.grig.routeguide.RouteSummary>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.RouteSummary.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ru.grig.routeguide.RouteNote,
      ru.grig.routeguide.RouteNote> getRouteChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteChat",
      requestType = ru.grig.routeguide.RouteNote.class,
      responseType = ru.grig.routeguide.RouteNote.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<ru.grig.routeguide.RouteNote,
      ru.grig.routeguide.RouteNote> getRouteChatMethod() {
    io.grpc.MethodDescriptor<ru.grig.routeguide.RouteNote, ru.grig.routeguide.RouteNote> getRouteChatMethod;
    if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
          RouteGuideGrpc.getRouteChatMethod = getRouteChatMethod = 
              io.grpc.MethodDescriptor.<ru.grig.routeguide.RouteNote, ru.grig.routeguide.RouteNote>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "routeguide.RouteGuide", "RouteChat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.RouteNote.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.grig.routeguide.RouteNote.getDefaultInstance()))
  ...
  public static abstract class RouteGuideImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeature(ru.grig.routeguide.Point request,
        io.grpc.stub.StreamObserver<ru.grig.routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    public void listFeatures(ru.grig.routeguide.Rectangle request,
        io.grpc.stub.StreamObserver<ru.grig.routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ru.grig.routeguide.Point> recordRoute(
        io.grpc.stub.StreamObserver<ru.grig.routeguide.RouteSummary> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ru.grig.routeguide.RouteNote> routeChat(
        io.grpc.stub.StreamObserver<ru.grig.routeguide.RouteNote> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.grig.routeguide.Point,
                ru.grig.routeguide.Feature>(
                  this, METHODID_GET_FEATURE)))
          .addMethod(
            getListFeaturesMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                ru.grig.routeguide.Rectangle,
                ru.grig.routeguide.Feature>(
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                ru.grig.routeguide.Point,
                ru.grig.routeguide.RouteSummary>(
                  this, METHODID_RECORD_ROUTE)))
          .addMethod(
            getRouteChatMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                ru.grig.routeguide.RouteNote,
                ru.grig.routeguide.RouteNote>(
  ...
  public static final class RouteGuideBlockingStub extends io.grpc.stub.AbstractStub<RouteGuideBlockingStub> {
     ...
     * </pre>
     */
    public ru.grig.routeguide.Feature getFeature(ru.grig.routeguide.Point request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ru.grig.routeguide.Feature> listFeatures(
        ru.grig.routeguide.Rectangle request) {
  ...
  public static final class RouteGuideFutureStub extends io.grpc.stub.AbstractStub<RouteGuideFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.grig.routeguide.Feature> getFeature(
        ru.grig.routeguide.Point request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEATURE:
          serviceImpl.getFeature((ru.grig.routeguide.Point) request,
              (io.grpc.stub.StreamObserver<ru.grig.routeguide.Feature>) responseObserver);
          break;
        case METHODID_LIST_FEATURES:
          serviceImpl.listFeatures((ru.grig.routeguide.Rectangle) request,
              (io.grpc.stub.StreamObserver<ru.grig.routeguide.Feature>) responseObserver);
          break;
        default:
  ...
  private static abstract class RouteGuideBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.grig.routeguide.RouteGuideProto.getDescriptor();
    }
